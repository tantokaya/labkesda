...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-ruangan').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('ruangan/dt_ruangan'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"lantai", "sName":"lantai", "sWidth":"5%"},
                {"data":"nama_gedung", "sName":"nama_gedung", "sWidth":"20%"},
                {"data":"nama_ruang", "sName":"nama_ruang", "sWidth":"20%"},
                {"data":"deskripsi", "sName":"deskripsi", "sWidth":"30%"},
                {"data":"pic", "sName":"pic", "sWidth":"20%"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('ruangan/add');?>";
        });

        $('#tbl-ruangan').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
