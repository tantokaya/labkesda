...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-sub-gol-tindakan').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('sub_gol_tindakan/dt_sub_gol_tindakan'); ?>',
            "bAutoWidth": false,
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('sub_gol_tindakan/add');?>";
        });

        $('#tbl-sub-gol-tindakan').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "<?=base_url('sub_gol_tindakan/delete');?>",
                            data: {id: id},
                            success: function(r){
