        ...
        <div class="panel-heading">
            ...
            <div class="elements panel-tabs">
                <ul class="nav nav-tabs nav-sm nav-tabs-bottom">
                    <li class="active"><a href="#arsip-publik" data-toggle="tab"><i class="icon-folder-open position-left"></i> Arsip Publik</a></li>
                    <li><a href="<?=base_url('arsip/saya');?>"><i class="icon-folder position-left"></i> Arsip Saya</a></li>
...
<script type="text/javascript" src="<?=base_url('assets/js/app/arsip_publik.js');?>"></script>
