...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-eksternal-peserta').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "scrollX": true,
            "sAjaxSource": '<?php echo base_url('eksternal_peserta/dt_eksternal_peserta'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"nm_peserta", "sName":"nm_peserta","sWidth":""},
                {"data":"email", "sName":"email","sWidth":""},
                {"data":"no_telepon", "sName":"no_telepon","sWidth":""},
                {"data":"no_npwp", "sName":"no_npwp","sWidth":""},
                {"data":"alamat", "sName":"alamat","sWidth":""},
                {"data":"nm_instansi", "sName":"nm_instansi","sWidth":""},
                {"data":"golongan", "sName":"golongan","sWidth":""},
                {"data":"jabatan", "sName":"jabatan","sWidth":""},
                {"data":"representatif", "sName":"representatif","sWidth":""},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('eksternal_peserta/add');?>";
        });

        $('#tbl-eksternal-peserta').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "<?=base_url('eksternal_peserta/delete');?>",
                            data: {id: id},
                            success: function(r){
