...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-eselon').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('eselon/dt_eselon'); ?>',
            "bAutoWidth": false,
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('eselon/add');?>";
        });

        $('#tbl-eselon').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
