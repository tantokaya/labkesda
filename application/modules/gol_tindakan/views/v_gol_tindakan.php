...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-gol-tindakan').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('gol_tindakan/dt_gol_tindakan'); ?>',
            "bAutoWidth": false,
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('gol_tindakan/add');?>";
        });
                ...
                function(isConfirm){
                    if (isConfirm){
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "<?=base_url('gol_tindakan/delete');?>",
                            data: {id: id},
                            success: function(r){
