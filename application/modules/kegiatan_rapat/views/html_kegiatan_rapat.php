...
<div class="header">
    <div class="header-content">
        <div class="page-title">
            <i class="icon-calendar2 position-left"></i>Tambah Kegiatan Rapat</div>
        <ul class="breadcrumb">
            <li><a href="<?=base_url()?>dashboard">Home</a></li>
            <li><a href="<?=base_url()?>kegiatan">Kegiatan</a></li>
            <li class="active">Tambah Kegiatan Rapat</li>
        </ul>
    </div>
</div>
...
<div class="container-fluid page-content">
    <div class="panel panel-default panel-bordered">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-three-bars position-left"></i> Tambah Kegiatan Rapat</h5>
        </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane" id="kegiatan-tab">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="select" style="width: 100%;" data-placeholder="-- Pilih Ruang --" name="ruang" id="ruang" required>
                                    <option></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="lantai" name="lantai" placeholder="Lantai..." disabled="" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control tokenfield-primary" id="pic" name="pic" value="" required />
                    ...
                    <div class="tab-pane" id="lampiran-tab">
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h5 class="panel-title">Upload Lampiran Rapat</h5>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                <!-- <style type="text/css">
                                    ...
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">Absensi </label>
                                            <div class="col-sm-10">
                                                 <input type="file" name="" class="form-control file" multiple="true" placeholder="Absensi..." required />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">Laporan Rapat </label>
                                            <div class="col-sm-10">
                                                 <input type="file" name="" class="form-control file" multiple="true" placeholder="Laporan Rapat..." required />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">Kwitansi Konsumsi </label>
                                            <div class="col-sm-10">
                                                 <input type="file" id="" name="" class="form-control file" multiple="true" placeholder="Kwitansi Konsumsi..." required />
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive" id="">
                                    <table class="table list-lampiran table-hover table-bordered">
                                        ...
                                        <tr>
                                            <th>Nama Laporan</th>
                                            <th data-toggle="true">File</th>
                                            <th>Status</th>
                                            <th style="width: 80px;" class="text-center">Aksi
                                        </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><button class="btn btn-xs btn-info" data-toggle="modal" data-target="#view"><i class="icon-eye"> View</i></button></td>
                                            </tr>
                                            <tr>
                                                <td>Surat Tugas</td>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="nm_peserta" name="nm_peserta" class="form-control ui-autocomplete-input" value="" autocomplete="off" required="" placeholder="Search...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">Nama Peserta</label>
                        <div class="col-sm-8">
                            <input type="text" id="nama" name="nama" class="form-control ui-autocomplete-input" value="" autocomplete="off" required="" placeholder="Search...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">Email</label>
                        <div class="col-sm-8">
                            <input type="text" id="emial" name="email" class="form-control" value="" autocomplete="off" required="" placeholder="Search...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">NPWP</label>
                        <div class="col-sm-8">
                            <input type="text" id="npwp" name="npwp" class="form-control" value="" autocomplete="off" required="" placeholder="Search...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">No. Telp / HP</label>
                        <div class="col-sm-8">
                            <input type="text" id="no_telepon" name="no_telepon" class="form-control" value="" placeholder="Search...">
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <style type="text/css">
                ...
                <p>Notes : Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
