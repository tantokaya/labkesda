...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-ruang-rapat').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('ruang_rapat/dt_ruang_rapat'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"tanggal", "sName":"tanggal", "sWidth":"10%"},
                {"data":"waktu", "sName":"waktu", "sWidth":"5%"},
                {"data":"nama_ruang", "sName":"nama_ruang", "sWidth":"10%"},
                {"data":"deskripsi_rapat", "sName":"deskripsi_rapat", "sWidth":"35%"},
                {"data":"pic", "sName":"pic", "sWidth":"15%"},
                {"data":"unit_kerja", "sName":"unit_kerja", "sWidth":"20%"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('ruang_rapat/add');?>";
        });

        $('#tbl-ruang-rapat').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "<?=base_url('ruang_rapat/delete');?>",
                            data: {id: id},
                            success: function(r){
