                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="kegiatan-tab">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="kegiatan" name="kegiatan" placeholder="Nama Kegiatan..." value="<?=isset($kegiatan['kegiatan'])?$kegiatan['kegiatan']:set_value('kegiatan');?>" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="tanggal_mulai" name="tanggal_mulai" class="form-control" placeholder="Tanggal Mulai" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <label class="radio-inline">
                                    <input type="radio" name="is_private" value="0" <?=isset($kegiatan['is_private']) && $kegiatan['is_private'] == '0'?'checked':'';?> disabled> Ya
                                </label>

                                <label class="radio-inline">
                                    <input type="radio" name="is_private" value="1" <?=isset($kegiatan['is_private']) && $kegiatan['is_private'] == '1'?'checked':'';?> disabled> Tidak
                                </label>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-calendar"></i></span>
                                    <input type="text" id="tanggal_akhir" name="tanggal_akhir" class="form-control" placeholder="Tanggal Akhir" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="select" style="width: 100%;" data-placeholder="-- Pilih Jenis Kegiatan --" name="jenis_kegiatan_id" id="jenis_kegiatan_id" disabled>
                                    <option></option>
                            ...
                            <div class="col-sm-2 non-perjadin">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="waktu_mulai" name="waktu_mulai" class="form-control" disabled>
                                </div>
                            </div>
                        ...
                        <div class="form-group non-perjadin">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="lokasi" name="lokasi" placeholder="Lokasi Kegiatan" value="<?=isset($kegiatan['lokasi'])?$kegiatan['lokasi']:'';?>" disabled />
                            </div>
                            <label class="control-label col-sm-2">Waktu Akhir <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-alarm"></i></span>
                                    <input type="text" id="waktu_akhir" name="waktu_akhir" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea name="keterangan" id="keterangan" class="form-control" disabled><?=isset($kegiatan['keterangan'])?$kegiatan['keterangan']:'';?></textarea>
                            </div>
...
<!-- HIDE OLD PIC INPUT -->
<!--                                --><?php //if(isset($kegiatan['pic'])):?>
<!--                                <input type="text" class="form-control tokenfield-primary" id="pic" name="pic" value="--><?//=isset($kegiatan['pic'])?$kegiatan['pic']:set_value('pic');?><!--" disabled />-->
<!--                                <span>Input diakhiri dengan tanda <code>koma (,)</code> atau tombol <code>TAB</code></span>-->
<!--                                --><?php //endif; ?>

                                <input type="hidden" id="pic" name="pic" value="<?=isset($kegiatan['pic'])?$kegiatan['pic']:set_value('pic');?>" disabled />

                                <select class="select" style="width: 100%;" data-placeholder="-- Pilih PIC --" name="pic_kegiatan[]" id="pic_kegiatan" multiple="multiple" disabled>
                                    <option value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
<!--                                <input type="text" class="form-control" id="mak" name="mak" placeholder="MAK..." value="--><?//=isset($kegiatan['mak'])?$kegiatan['mak']:set_value('mak');?><!--" disabled />-->
                                <select class="select" style="width: 100%;" data-placeholder="MAK..." name="mak" id="mak_select" disabled>
                                    <option></option>
                            ...
                            <div class="col-sm-4 perjadin">
                                <select class="select" style="width: 100%;" data-placeholder="-- Pilih Tipe Perjadin --" name="tipe_perjadin" id="tipe_perjadin" disabled>
                                    <option value=""></option>
                            ...
                            <div class="col-sm-4 non-perjadin">
                                <select class="select" style="width: 100%;" data-placeholder="-- Pilih Subsektor --" name="subsektor[]" id="subsektor" multiple="multiple" disabled>
                                    <option value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="desc_mak" id="desc_mak" class="form-control" disabled><?=isset($kegiatan['deskripsi_mak'])?$kegiatan['deskripsi_mak']:set_value('deskripsi_mak');?></textarea>
                            </div>
                        </div>
...
//                        $('.tab-menu a[href="#lampiran-tab"]').tab('show');
        ...
        function getListLampiran(id) {
            $.ajax({
                type: "POST",
                url: "<?=base_url('laporan_tata_usaha/get_list_lampiran');?>",
                data: {id: id},
                success: function (res) {
...
//    });
        $('#eksternal-tab').delegate('button#btn-add-peserta', 'click', function(e){
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('kegiatan/form_peserta_add_eksternal');?>",
                data: {id: $('#kegiatan_id').val(),jenis_kegiatan_id: $('#jenis_kegiatan_id').val()},
                success: function (result) {
                    $('#modal_content').html(result);
                    if($('#jenis_kegiatan_id').val() == '3'){
        ...
        $('#simpan').on('click', function(e){
            ...
            $.ajax({
                type:   "POST",
                dataType: "json",
                data: $('#frm-tu').serializeArray(),
                url: "<?=base_url('laporan_tata_usaha/notes');?>",
                success: function(response){
                    if(response.error == false){
                        ...
                        tableInternal.api().ajax.reload()
                        tableEksternal.api().ajax.reload()
                ...
                error: function(){
                    options.title       = "Error";
                    options.text        = "Validasi gagal diperbaharui!";
                    options.addclass    = "bg-danger";
                    options.type        = "error";
                    options.icon        = "icon-blocked";
        ...
        // getListInternal('<?=$kegiatan['kegiatan_id'];?>');
        // getListEksternal('<?=$kegiatan['kegiatan_id'];?>');
