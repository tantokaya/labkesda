...
<div id="view<?=encode($t['lampiran_kegiatan_id'])?>" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="modal_title" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?=base_url()?>laporan_tata_usaha/notes" class="form-horizontal" id="frm-tu" method="post">
                <input type="hidden" name="lampiran_kegiatan_id" id="lampiran_kegiatan_id" value="<?=encode($t['lampiran_kegiatan_id'])?>">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" style="width: 100%;" name="status_tu" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="reply_tu" id="reply_tu" class="form-control">-</textarea>
                            </div>
                        </div>
                    </div>
                </div>
