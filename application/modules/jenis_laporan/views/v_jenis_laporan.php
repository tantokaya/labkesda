...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-jenis-laporan').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('jenis_laporan/dt_jenis_laporan'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"jenis_laporan", "sName":"jenis_laporan", "sWidth":"95%"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('jenis_laporan/add');?>";
        });

        $('#tbl-jenis-laporan').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "<?=base_url('jenis_laporan/delete');?>",
                            data: {id: id},
                            success: function(r){
