...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-mak').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('mak/dt_mak'); ?>',
            "bAutoWidth": false,
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('mak/add');?>";
        });

        $('#tbl-mak').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
