...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-crbayar').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('crbayar/dt_crbayar'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"crbayar_nama", "sName":"crbayar_nama"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('crbayar/add');?>";
        });

        $('#tbl-crbayar').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
