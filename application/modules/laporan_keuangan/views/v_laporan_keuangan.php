...
<div id="mdl_selesai" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="modal_title" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form action="<?=base_url()?>laporan_keuangan/selesai" method="POST">
...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-laporan-keuangan').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('laporan_keuangan/dt_laporan_keuangan'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                ...
                {"data": "status_keuangan", "sName":"status_keuangan", "sWidth":"10%", render: function(data) {
                    if(data == 1) {
