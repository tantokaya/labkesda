...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-tindakan').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('tindakan/dt_tindakan'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"tindakan", "sName":"tindakan"},
                {"data":"gol_tindakan_nama", "sName":"gol_tindakan_nama"},
                {"data":"sub_gol_tind_nama", "sName":"sub_gol_tind_nama"},
                {"data":"harga", "sName":"harga"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('tindakan/add');?>";
        });

        $('#tbl-gol-tindakan').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
