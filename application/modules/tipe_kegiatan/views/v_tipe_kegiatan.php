...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-tipe-kegiatan').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('tipe_kegiatan/dt_tipe_kegiatan'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"tipe_kegiatan", "sName":"tipe_kegiatan"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('tipe_kegiatan/add');?>";
        });

        $('#tbl-tipe-kegiatan').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "<?=base_url('tipe_kegiatan/delete');?>",
                            data: {id: id},
                            success: function(r){
