...
<div class="container-fluid page-content">
    ...
    <div class="panel panel-default panel-bordered">
        ...
        <div class="panel-body">
            <?=form_open('', array('id' => 'frm-agama','class' => 'form-horizontal'))?>
            <div class="form-group">
                <label class="control-label col-sm-2">Agama <span class="text-danger">*</span></label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="agama" name="agama" placeholder="Agama..." value="<?=isset($agama['agama'])?$agama['agama']:set_value('agama');?>" required>
                </div>
            </div>
