...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-status-jabatan').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('status_jabatan/dt_status_jabatan'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"status_jabatan", "sName":"status_jabatan"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('status_jabatan/add');?>";
        });

        $('#tbl-status-jabatan').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "<?=base_url('status_jabatan/delete');?>",
                            data: {id: id},
                            success: function(r){
