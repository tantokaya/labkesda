        ...
        <div class="tab-pane active" id="kegiatan-tab">
            <div class="table-responsive">
                <table class="table table-striped">
                    <tbody>
                    <tr>
                        <td style="width: 25%;">Kegiatan</td>
                        <td style="width: 1%;">:</td>
                        <td style="width: 74%;"><?=$kegiatan['kegiatan'];?></td>
                    </tr>
                    <tr>
                        <td>Tipe Kegiatan</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Tanggal Mulai</td>
                        <td>:</td>
                        <td><?=$this->functions->convert_date_indo(array('datetime' => $kegiatan['tanggal_mulai']));?></td>
                    </tr>
                    <tr>
                        <td>Tanggal Akhir</td>
                        <td>:</td>
                        <td><?=$this->functions->convert_date_indo(array('datetime' => $kegiatan['tanggal_akhir']));?></td>
                    </tr>
                    <tr>
                        <td>Propinsi Tujuan</td>
                        <td>:</td>
                        <td><?=$propinsi['propinsi'];?></td>
                    </tr>
                    <tr>
                        <td>Kota Tujuan</td>
                        <td>:</td>
