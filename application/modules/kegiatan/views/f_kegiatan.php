        ...
        <div class="panel-body">
            <div class="tabbable">
                <ul class="nav nav-tabs nav-tabs-highlight nav-bordered tab-menu" id="tab-kegiatan">
                    ...
                    <li class="<?=$type=='add'?'disabled':'';?>"><a href="#internal-tab" <?=$type=='edit'?'data-toggle="tab"':'';?> aria-expanded="false"><i class="icon-users2"></i> Internal</a></li>
                    <li class="<?=$type=='add'?'disabled':'';?>"><a href="#eksternal-tab" <?=$type=='edit'?'data-toggle="tab"':'';?> aria-expanded="false"><i class="icon-users2"></i> Eksternal</a></li>
                </ul>
...
<!--                                --><?php //endif; ?>
                                ...
                                <input type="hidden" id="pic" name="pic" value="<?=isset($kegiatan['pic'])?$kegiatan['pic']:set_value('pic');?>" required />
                ...
                success: function(r){
                    if(r.error == false){
                        ...
                        if(r.flag == 'insert'){
                            ...
                            getListInternal(r.kegiatan_id);
                            getListEksternal(r.kegiatan_id);
                        }
...
//                url: "<?//=base_url('kegiatan/get_list_peserta');?>//",
                url: "<?=base_url('kegiatan/get_list_peserta_kegiatan');?>",
                data: {id: id},
                success: function(res){
