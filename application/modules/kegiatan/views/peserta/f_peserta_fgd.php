...
<?=form_open('kegiatan/save_peserta', array('id' => 'frm-peserta', 'class' => 'form-horizontal'));?>
    ...
    <input type="hidden" id="pegawai_id" name="pegawai_id" value="<?= $peserta['pegawai_id']; ?>"/>
    <input type="hidden" id="peserta_eksternal_id" name="peserta_eksternal_id" value="<?= $peserta['peserta_eksternal_id']; ?>" />
    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input readonly type="text" id="nm_peserta" name="nm_peserta" class="form-control"
                           value="<?=isset($peserta['nm_peserta'])?$peserta['nm_peserta']:'';?><?=isset($peserta['nm_pegawai'])?$peserta['nm_pegawai']:'';?>" autocomplete="off" required />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4">Alamat Peserta</label>
                <div class="col-sm-8">
                    <textarea readonly id="alamat_peserta" name="alamat_peserta" class="form-control"><?=isset($peserta['alamat'])?$peserta['alamat']:'';?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4">Nama Instansi <span class="text-danger">*</span></label>
                <div class="col-sm-8">
                    <input readonly type="text" id="nm_instansi" name="nm_instansi" class="form-control" value="<?=isset($peserta['nm_instansi'])?$peserta['nm_instansi']:'Bekraf';?>" autocomplete="off" required />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4">Jabatan</label>
                <div class="col-sm-8">
                    <input readonly type="text" id="jabatan" name="jabatan" class="form-control" value="<?=isset($peserta['jabatan'])?$peserta['jabatan']:'';?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4">Golongan</label>
                <div class="col-sm-8">
                    <input readonly type="text" id="golongan" name="golongan" class="form-control" value="<?=isset($peserta['golongan'])?$peserta['golongan']:'';?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4">No. Telp / HP</label>
                <div class="col-sm-8">
                    <input readonly type="text" id="no_telepon" name="no_telepon" class="form-control" value="<?=isset($peserta['no_telepon'])?$peserta['no_telepon']:'';?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4">Email</label>
                <div class="col-sm-8">
                    <input readonly type="text" id="email" name="email" class="form-control" value="<?=isset($peserta['email'])?$peserta['email']:'';?>" />
                </div>
            </div>
        </div>
        <div class="col-md-6 col-sm-12">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input readonly type="text" id="no_npwp" name="no_npwp" class="form-control" value="<?=isset($peserta['no_npwp'])?$peserta['no_npwp']:'';?>" />
                </div>
            </div>
            <div class="form-group">
