...
<?=form_open('kegiatan/save_peserta', array('id' => 'frm-peserta', 'class' => 'form-horizontal'));?>
    ...
    <div class="row">
        <div class="col-md-7 col-sm-12">
            <?php if($peserta['peserta_eksternal_id'] != null):; ?>
            <div class="form-group">
                <label class="control-label col-sm-4">No. NPWP <span class="text-danger">*</span></label>
                <div class="col-sm-6">
                    <input type="text" id="no_npwp" name="no_npwp" class="form-control" value="<?=isset($peserta['no_npwp'])?$peserta['no_npwp']:'';?>" autocomplete="off" disabled/>
                </div>
            </div>
            <?php else:?>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input readonly type="text" id="nip" name="nip" class="form-control" value="<?=isset($peserta['nip'])?$peserta['nip']:'';?>" autocomplete="off" required />
                </div>
            </div>
            <?php endif?>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input readonly type="text" id="nm_peserta" name="nm_peserta" class="form-control" value="<?=isset($peserta['nm_peserta'])?$peserta['nm_peserta']:'';?><?=isset($peserta['nm_pegawai'])?$peserta['nm_pegawai']:'';?>" autocomplete="off" required />
                </div>
            </div>
            <div class="form-group">
