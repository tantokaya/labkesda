...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-unit-kerja').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('unit_kerja/dt_unit_kerja'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"unit_kerja_id", "sName":"unit_kerja_id", "sWidth":"15%"},
                {"data":"unit_kerja", "sName":"unit_kerja", "sWidth":"40%"},
                {"data":"akses", "sName":"akses", "sWidth":"15%"},
                {"data":"eselon", "sName":"eselon", "sWidth":"5%"},
                {"data":"jabatan", "sName":"jabatan", "sWidth":"15%"}, 
                {"data":"mark", "sName":"mark", "sWidth":"5%"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('unit_kerja/add');?>";
        });

        $('#tbl-unit-kerja').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "<?=base_url('unit_kerja/delete');?>",
                            data: {id: id},
                            success: function(r){
