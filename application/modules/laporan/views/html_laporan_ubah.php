...
<div class="header">
    <div class="header-content">
        <div class="page-title">
            <i class="icon-calendar2 position-left"></i>Laporan Kegiatan Rapat</div>
        <ul class="breadcrumb">
            <li><a href="<?=base_url()?>dashboard">Home</a></li>
            <li><a href="<?=base_url()?>kegiatan">Laporan</a></li>
            <li class="active">Laporan Kegiatan Rapat</li>
        </ul>
    </div>
</div>
...
<div class="container-fluid page-content">
    <div class="panel panel-default panel-bordered">
        <div class="panel-heading">
            <h5 class="panel-title"><i class="icon-three-bars position-left"></i> Laporan Kegiatan Rapat</h5>
        </div>
        <div class="panel-body">
            <div class="tabbable">
                <ul class="nav nav-tabs nav-tabs-highlight nav-bordered tab-menu" id="tab-kegiatan">
                    ...
                    <li class=""><a href="#peserta-tab" data-toggle="tab" aria-expanded="false"><i class="icon-users2"></i> Daftar Peserta Kegiatan</a></li>
                </ul>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="kegiatan-tab">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="select" style="width: 100%;" data-placeholder="-- Kode Satuan Kerja --" name="kode_satuan_kerja" id="kode_satuan_kerja" disabled="">
                                    <option></option>
                                        <option value="1" >BEK1</option>
                                        <option value="2" selected>RO1</option>
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="kegiatan" name="kegiatan" placeholder="Nama Kegiatan..." value="Press conference Pendukungan Indonesia dalam Ambiente" disabled="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2">Tipe Kegiatan <span class="text-danger">*</span></label>
                            <div class="col-sm-4">
                                <select class="select" style="width: 100%;" data-placeholder="-- Pilih Tipe Kegiatan --" name="tipe_kegiatan_id" id="tipe_kegiatan_id" disabled="">
                                    <option></option>
                                        <option value="1" >Perorangan</option>
                                        <option value="2" selected="">Grup</option>
                                    </select>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="tanggal_mulai" name="tanggal_mulai" class="form-control" placeholder="Tanggal Mulai" value="25/03/2017" disabled="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <label class="radio-inline">
                                    <input type="radio" name="is_private" value="0" checked="" disabled=""> Ya
                                </label>

                                <label class="radio-inline">
                                    <input type="radio" name="is_private" value="1" disabled=""> Tidak
                                </label>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-calendar"></i></span>
                                    <input type="text" id="tanggal_akhir" name="tanggal_akhir" class="form-control" placeholder="Tanggal Akhir" value="26/03/2017" disabled="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2">Ruang <span class="text-danger">*</span></label>
                            <div class="col-sm-4">
                                <select class="select" style="width: 100%;" data-placeholder="-- Pilih Ruang --" name="ruang" id="ruang" disabled="">
                                    <option></option>
                                        <option value="1" selected="">Ruang Rapat</option>
                                </select>
                            </div>
                            <label class="control-label col-sm-2">Waktu Mulai <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-alarm"></i></span>
                                    <input type="text" id="waktu_mulai" name="waktu_mulai" class="form-control" value="08.00 AM" disabled="">
                                </div>
                            </div>
                            <label class="control-label col-sm-2 perjadin">Propinsi Tujuan <span class="text-danger">*</span></label>
                            <div class="col-sm-4 perjadin">
                                <select class="select" style="width: 100%;" data-placeholder="-- Pilih Propinsi Tujuan--" name="propinsi_id" id="propinsi_id" disabled="">
                                    <option value=""></option>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2">Lantai </label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="lantai" name="lantai" placeholder="Lantai..." value="18" disabled="" />
                            </div>
                            <label class="control-label col-sm-2">Waktu Akhir <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-alarm"></i></span>
                                    <input type="text" id="waktu_mulai" name="waktu_mulai" class="form-control" value="10.00 AM" disabled="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control tokenfield-primary" id="pic" name="pic" value="Administrator" disabled="" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2">MAK <span class="text-danger">*</span></label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="mak" name="mak" placeholder="MAK..." value="189.990" disabled="" />
                            </div>
                            <label class="control-label col-sm-2 perjadin">Kota/Kab. Tujuan <span class="text-danger">*</span></label>
                            <div class="col-sm-4 perjadin">
                                <select class="select" style="width: 100%;" data-placeholder="-- Pilih Kota/Kab. Tujuan --" name="kota_id" id="kota_id" disabled="">
                                    <option value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="desc_mak" id="desc_mak" class="form-control" disabled="">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                                ...
                                <div class="table-responsive" id="">
                                    <table class="table list-lampiran table-hover table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 5%;" class="text-center">Aksi
                                        </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><button class="btn btn-xs btn-info" data-toggle="modal" data-target="#view"><i class="icon-pencil"> Aksi</i></button></td>
                                            </tr>
                                            <tr>
                                                <td>Surat Tugas</td>
                                                <td>surat_tugas.pdf</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 id="" class="modal-title">Tambah Peserta Kegiatan FGD / Rapat / Seminar</h4>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="nm_peserta" name="nm_peserta" class="form-control ui-autocomplete-input" value="" autocomplete="off" required="">
                        </div>
                    </div>
                    <div class="form-group">
...
<div id="view" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="modal_title" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 id="" class="modal-title">Status</h4>
            </div>
            <div class="modal-body" id="">
            <style type="text/css">
                .ui-autocomplete {
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <select class="form-control" style="width: 100%;" data-placeholder="-- Status --" >
                            <option></option>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#ruang').on('change', function(){
            ...
            $.ajax({
                url: '<?=base_url('kegiatan_rapat/get_ruang/'); ?>'+ruang_id,
                type: 'GET',
                dataType: 'JSON',
                success:function(data)
                {
