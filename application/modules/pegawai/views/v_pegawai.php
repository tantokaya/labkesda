...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-pegawai').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('pegawai/dt_pegawai'); ?>',
            "bAutoWidth": false,
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('pegawai/add');?>";
        });

        $('#tbl-pegawai').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
