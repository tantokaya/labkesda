...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-akses').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('akses/dt_akses'); ?>',
            "bAutoWidth": false,
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('akses/add');?>";
        });

        $('#tbl-akses').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
