...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-golongan').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('golongan/dt_golongan'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"golongan", "sName":"golongan"},
                {"data":"deskripsi", "sName":"deskripsi"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('golongan/add');?>";
        });

        $('#tbl-golongan').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
