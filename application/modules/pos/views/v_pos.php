                                                    ...
                                                    <div class="client-details-box clearfix">
                                                        <div class="client-details-left">
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium;width: 20%;">NIK</span>
                                                                <?php if ($this->uri->segment(3) == '') { ?>
                                                                    <input style="text: 40%" type="hidden"
                                                                           name="kd_rekmed" id="kd_rekmed"
                                                                           value="<?= $kd_rekmed; ?>">
                                                                <?php } else { ?>
                                                                    <input style="width: 40%" type="hidden" name="nik"
                                                                           id="nik"
                                                                           value="<?= isset($pelanggan['kd_rekmed']) ? $pelanggan['kd_rekmed'] : set_value('kd_rekmed'); ?>">
                                                                <?php } ?>
                                                                <input style="width: 40%" type="text" name="nik"
                                                                       id="nik"
                                                                       value="<?= isset($pelanggan['nik']) ? $pelanggan['nik'] : set_value('nik'); ?>">
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium;width: 20%;">Tmp Lahir</span>
                                                                <input style="width: 40%" name="tmp_lahir"
                                                                       id="tmp_lahir"
                                                                       value="<?= isset($pelanggan['tmp_lahir']) ? $pelanggan['tmp_lahir'] : set_value('tmp_lahir'); ?>">
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium;width: 20%;">Tgl Lahir</span>
                                                                <input style="width: 25%" name="tgl_lahir"
                                                                       id="tgl_lahir"
                                                                       value="<?= isset($pelanggan['tgl_lahir']) ? $this->functions->convert_date_indo(array('datetime' => $pelanggan['tgl_lahir'])) : ''; ?>">
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium;width: 20%;">Agama</span>
                                                                <select style="height: 35px;"
                                                                        data-placeholder="-- Pilih Agama --"
                                                                        name="agama_id" id="agama_id" required>
                                                                    <option></option>
                                                                    <?php foreach ($l_agama as $t): ?>
                                                                        <?php if (isset($pelanggan['agama_id']) && $pelanggan['agama_id'] == $t['agama_id']): ?>
                                                                            <option value="<?= $t['agama_id']; ?>"
                                                                                    selected><?= $t['agama']; ?></option>
                                                                        <?php else : ?>
                                                                            <option
                                                                                value="<?= $t['agama_id']; ?>" <?= set_select('agama_id', $t['agama_id']) ?>><?= $t['agama']; ?></option>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium;width: 20%;">L / P</span>
                                                                <?php foreach ($l_jenis_kelamin as $t): ?>
                                                                    <?php if (isset($pelanggan['jenis_kelamin_id']) && $pelanggan['jenis_kelamin_id'] == $t['jenis_kelamin_id']) : ?>
                                                                        <label class="radio-inline">
                                                                            <input type="radio" name="jenis_kelamin_id"
                                                                                   id="jenis_kelamin_id"
                                                                                   value="<?= $t['jenis_kelamin_id']; ?>"
                                                                                   checked> <?= $t['jenis_kelamin']; ?>
                                                                        </label>
                                                                    <?php else : ?>
                                                                        <label class="radio-inline">
                                                                            <input type="radio" name="jenis_kelamin_id"
                                                                                   id="jenis_kelamin_id"
                                                                                   value="<?= $t['jenis_kelamin_id']; ?>" <?= set_radio('jenis_kelamin_id', $t['jenis_kelamin_id']); ?>> <?= $t['jenis_kelamin']; ?>
                                                                        </label>
                                                                    <?php endif; ?>
                                                                <?php endforeach; ?>
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium;width: 20%;">Alamat</span>
                                                                <input class="" name="alamat" id="alamat"
                                                                ...
                                                                <select name="propinsi_id" style="height: 35px;"
                                                                    ...
                                                                    <?php foreach ($l_propinsi as $t): ?>
                                                                        <?php if ($pelanggan['propinsi_id'] == $t->propinsi_id): ?>
                                                                            <option
                                                                                value="<?php echo $t->propinsi_id; ?>"
                                                                                selected="selected"><?php echo $t->propinsi; ?></option>
                                                                        <?php else : ?>
                                                                            <option
                                                                                value="<?php echo $t->propinsi_id; ?>"><?php echo $t->propinsi; ?></option>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium;width: 20%;">Kota</span>
                                                                <select name="kota_id" id="kota_id" style="height:35px"
                                                                        required>
                                                                    <option></option>
                                                                    <?php if (isset($l_kota)): ?>
                                                                        <?php foreach ($l_kota as $t): ?>
                                                                            <?php if ($pelanggan['kota_id'] == $t->kota_id): ?>
                                                                                <option
                                                                                    value="<?php echo $t->kota_id; ?>"
                                                                                    selected="selected"><?php echo $t->kota; ?></option>
                                                                            <?php else : ?>
                                                                                <option
                                                                                    value="<?php echo $t->kota_id; ?>"><?php echo $t->kota; ?></option>
                                                                            <?php endif; ?>
                                                                        <?php endforeach; ?>
                                                                    <?php endif; ?>
                                                                </select>
                                                            ...
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium;width: 20%;">Kecamatan</span>
                                                                    ...
                                                                    <?php if (isset($l_kecamatan)): ?>
                                                                        <?php foreach ($l_kecamatan as $t): ?>
                                                                            <?php if ($pelanggan['kecamatan_id'] == $t->kecamatan_id): ?>
                                                                                <option
                                                                                    value="<?php echo $t->kecamatan_id; ?>"
                                                                                    selected="selected"><?php echo $t->kecamatan; ?></option>
                                                                            <?php else : ?>
                                                                                <option
                                                                                    value="<?php echo $t->kecamatan_id; ?>"><?php echo $t->kecamatan; ?></option>
                                                                            <?php endif; ?>
                                                                        <?php endforeach; ?>
                                                                    <?php endif; ?>
                                                                </select>
                                                            ...
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium; width: 20%;">Kelurahan</span>
                                                                    ...
                                                                    <?php if (isset($l_kelurahan)): ?>
                                                                        <?php foreach ($l_kelurahan as $t): ?>
                                                                            <?php if ($pelanggan['kelurahan_id'] == $t->kelurahan_id): ?>
                                                                                <option
                                                                                    value="<?php echo $t->kelurahan_id; ?>"
                                                                                    selected="selected"><?php echo $t->kelurahan; ?></option>
                                                                            <?php else : ?>
                                                                                <option
                                                                                    value="<?php echo $t->kelurahan_id; ?>"><?php echo $t->kelurahan; ?></option>
                                                                            <?php endif; ?>
                                                                        <?php endforeach; ?>
                                                                    <?php endif; ?>
                                                                </select>
                                                        ...
                                                        <div class="client-details-right">
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium; width: 20%">No KK</span>
                                                                <input class="detail" style="width: 40%" id="no_kk"
                                                                       name="no_kk" type="no_kk"
                                                                       value="<?= isset($pelanggan['no_kk']) ? $pelanggan['no_kk'] : set_value('no_kk'); ?>">
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium; width: 20%">Nama KK</span>
                                                                <input class="detail" style="width: 40%" name="nm_kk"
                                                                       id="nm_kk" type="text"
                                                                       value="<?= isset($pelanggan['nm_kk']) ? $pelanggan['nm_kk'] : set_value('nm_kk'); ?>">
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium; width: 20%">Goldar</span>
                                                                <select style="height: 35px; width: 20%"
                                                                        data-placeholder="-- Pilih Goldar --"
                                                                        name="goldar_id" id="goldar_id" required>
                                                                    <option></option>
                                                                    <?php foreach ($l_goldar as $t): ?>
                                                                        <?php if (isset($pelanggan['goldar_id']) && $pelanggan['goldar_id'] == $t['goldar_id']): ?>
                                                                            <option value="<?= $t['goldar_id']; ?>"
                                                                                    selected><?= $t['goldar_nama']; ?></option>
                                                                        <?php else : ?>
                                                                            <option
                                                                                value="<?= $t['goldar_id']; ?>" <?= set_select('goldar_id', $t['goldar_id']) ?>><?= $t['goldar_nama']; ?></option>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium; width: 20%">Pendidikan</span>
                                                                <select style="height: 35px; width: 30%"
                                                                    ...
                                                                    <?php foreach ($l_pendidikan as $t): ?>
                                                                        <?php if (isset($pelanggan['pendidikan_id']) && $pelanggan['pendidikan_id'] == $t['pendidikan_id']): ?>
                                                                            <option value="<?= $t['pendidikan_id']; ?>"
                                                                                    selected><?= $t['pendidikan_nama']; ?></option>
                                                                        <?php else : ?>
                                                                            <option
                                                                                value="<?= $t['pendidikan_id']; ?>" <?= set_select('pendidikan_id', $t['pendidikan_id']) ?>><?= $t['pendidikan_nama']; ?></option>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium; width: 20%">Pekerjaan</span>
                                                                <select style="height: 35px;"
                                                                        data-placeholder="-- Pilih Pekerjaan --"
                                                                        name="pekerjaan_id" id="pekerjaan_id" required>
                                                                    <option></option>
                                                                    <?php foreach ($l_pekerjaan as $t): ?>
                                                                        <?php if (isset($pelanggan['pekerjaan_id']) && $pelanggan['pekerjaan_id'] == $t['pekerjaan_id']): ?>
                                                                            <option value="<?= $t['pekerjaan_id']; ?>"
                                                                                    selected><?= $t['pekerjaan_nama']; ?></option>
                                                                        <?php else : ?>
                                                                            <option
                                                                                value="<?= $t['pekerjaan_id']; ?>" <?= set_select('pekerjaan_id', $t['pekerjaan_id']) ?>><?= $t['pekerjaan_nama']; ?></option>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
                                                            <div class="client-detail">
                                                                <span class="label"
                                                                      style="color: grey; font-size: medium; width: 20%">Status</span>
                                                                <select style="height: 35px; width: 30%"
                                                                        data-placeholder="-- Pilih Status --"
                                                                        name="stmarital_id" id="stmarital_id" required>
                                                                    <option></option>
                                                                    <?php foreach ($l_stmarital as $t): ?>
                                                                        <?php if (isset($pelanggan['stmarital_id']) && $pelanggan['stmarital_id'] == $t['stmarital_id']): ?>
                                                                            <option value="<?= $t['stmarital_id']; ?>"
                                                                                    selected><?= $t['stmarital_nama']; ?></option>
                                                                        <?php else : ?>
                                                                            <option
                                                                                value="<?= $t['stmarital_id']; ?>" <?= set_select('stmarital_id', $t['stmarital_id']) ?>><?= $t['stmarital_nama']; ?></option>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
