<table class="table table-transaksi">
    <thead>
    <tr>
        <th>Qty</th><th>Nama</th><th>Harga</th>
    </tr>
    </thead>
        <tbody>
        <?php
    ...
    <tr>
        ...
        <td align="right" name="total_beli" id="total_beli" style="font-weight: bold; font-style: italic" data-gtotal="<?= $g_total; ?>"><?= 'Rp '.number_format($g_total);?></td>
    </tr>
</table>