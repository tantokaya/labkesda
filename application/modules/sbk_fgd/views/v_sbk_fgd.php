...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-sbk-fgd').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('sbk_fgd/dt_sbk_fgd'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                ...
                {"data":"fblk", "sName":"fblk"},
                {"data":"fbdk", "sName":"fbdk"},
                {"data":"fddk", "sName":"fddk"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('sbk_fgd/add');?>";
        });
