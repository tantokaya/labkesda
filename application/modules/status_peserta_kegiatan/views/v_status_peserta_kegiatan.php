...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable = $('#tbl-status-peserta').dataTable( {
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url('status_peserta_kegiatan/dt_status_peserta_kegiatan'); ?>',
            "bAutoWidth": false,
            ...
            "columns": [
                {"data":"status_peserta", "sName":"status_peserta"},
        ...
        $('#btn-add').on('click', function(e) {
            window.location.href = "<?=base_url('status_peserta_kegiatan/add');?>";
        });

        $('#tbl-status-peserta').delegate('a.btn-delete', 'click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            swal({
                ...
                function(isConfirm){
                    if (isConfirm){
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "<?=base_url('status_peserta_kegiatan/delete');?>",
                            data: {id: id},
                            success: function(r){
